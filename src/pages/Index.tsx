        ...
        <main className="py-10">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-brand-blue hover:bg-brand-darkBlue text-white py-6 px-8 text-lg gap-2" asChild>
                <Link to="/user/auth">
              ...
              <Button className="bg-brand-green hover:bg-brand-green/90 text-white py-6 px-8 text-lg gap-2" asChild>
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-brand-darkBlue mb-6">Ready to transform your real estate experience?</h3>
